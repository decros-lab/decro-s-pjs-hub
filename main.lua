...
local SecServerKillAll=ServerTab:Section({Name="Kill all"})
getgenv().selectedPlayerName = ""
getgenv().TargetPlayersArrow = false
getgenv().AllArrow = false
SecServerKillAll:Textbox({Name="Player Target",Placeholder="zdecro, madin, me",Callback=function(v)
