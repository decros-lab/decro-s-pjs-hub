...
if (objCenter-screenCenter).Magnitude<30 then PlayTween(object,{Position=UDim2.new(0.5,0,0.5,0)}) end end end) end end))
...
if input==DragInput and Dragging then Update(input) end end)) end
